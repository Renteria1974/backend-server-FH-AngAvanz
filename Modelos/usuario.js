...
// Variable para cargar el módulo de Mongoose-unique-validator, nos va a servir para validar lso campos con la propiedad "unique=true"
...
// Definimos el esquema de nuestra colección de Usuarios, es la estructura que a a tener el objeto
// "Esquema" = Función que recibe un objeto de JavaScript
var EsquemaUsuario = new Esquema({
    // "required:[true,]"           = Indicamos que es un campo requerido
    // "'El nombre es Necesario'"   = Comentario que se mostrará cuando la condición de "required=true" no se cumpla
    // unique:true                  = Indicamos que el valor delcampo es único, no se puede repetir
